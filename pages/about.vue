<template>
    <div>
        ...
        <v-main class="d-flex wrap">
            ...
            <v-card outlined dark class="px-4 py-4" style="background-color: transparent">
                <p class="text-center text-sm-h5 text-h7">I am 17 years old, and I am currently studying at Thammasat KhlongLuang Withayakhom School. <br><br> 
